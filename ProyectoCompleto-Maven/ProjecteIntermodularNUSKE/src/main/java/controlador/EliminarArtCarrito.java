 ...
 * @author dncub
 */
public class EliminarArtCarrito extends HttpServlet {
...
//                System.out.println("ID CESTA:" + carrito.getCodigo());
                
                String idProducto = request.getParameter("id");
                
//                System.out.println("ID PRODUCTO: " + idProducto);
                
                LineaArticuloDAO la = new LineaArticuloDAO();

                // NO VA -> && strCantidad.chars().allMatch(Character::isDigit) -- PREGUNTAR A JOSÉ RAMÓN
                if (idProducto != null) {
                    la.eliminar(idProducto, carrito.getCodigo());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EliminarArtCarrito.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
