...
<head>
    ...
    <link rel="stylesheet" href="css/reg-socios/styles.css">
    <link
      rel="stylesheet"
            ...
            <section class="especifico">
              ...
              <input type="text" id="direccion" name="direccion" required><br>
                ...
                <h3>Información de empresa</h3>
                    ...
                    <label for="nombre-empresa">Nombre de la empresa</label><br>
                    <input type="text" id="nombre-empresa" name="nombre-empresa"><br>
                  
                    <label for="telefono-empresa">Teléfono de la empresa</label><br>
                    <input type="tel" id="telefono-empresa" name="telefono-empresa"><br>
                  
                    <label for="correo-empresa">Correo de la empresa</label><br>
                    <input type="email" id="correo-empresa" name="correo-empresa"><br>
        
                    <label for="ciudad">Ciudad de la empresa</label><br>
